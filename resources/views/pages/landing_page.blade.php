...
<body class="defult-home">
    ...
    <div class="full-width-header   header-style1 home1-modifiy">
        ...
        <header id="sc-header" class="sc-header">
            <!-- Topbar Area Start -->
            <div class="topbar-area" style = "height: 50px;">
            ...
            <div class="footer-newsletter">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6" align="right">
                        ...
                        <form action="https://legendaryestatesairbnb.us6.list-manage.com/subscribe/post?u=fe69a94aa0e22c2c5a0402524&amp;id=0f1ed11076" method="post" class="newsletter-form">
